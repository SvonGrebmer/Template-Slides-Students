...
This section contains templates for different formatting elements, which can be modified and adapted for the instructor's individual purposes. 

---

## Figure with caption

- Centered image with centered caption below in italics
